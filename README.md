...
本手册与演示工作区中的人物均为文生图生成的虚构成年人，不对应真实公众人物或可识别个人。生成提示词和资产说明见 [虚拟身份演示素材](docs/demo-assets/fictional-identities/README.md)。
...
界面分为三层：左侧栏按功能域切换页面，顶部流程按制作顺序导航，底部终端标签是任务队列与日志的唯一入口。状态颜色保持统一：亮绿表示正在运行，绿色表示完成，琥珀色表示等待或需要留意，红色表示失败；紫色只用于 XSeg 功能识别。当前查看的流程步骤会保留自身真实状态，并增加轮廓提示，不会把“正在查看”误写成“正在运行”。
