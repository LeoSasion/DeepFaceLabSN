...
const installPreview = {
  ...
  installPath: "C:\\DFL-WEBUI",
  projectDir: "C:\\DFL-WEBUI",
  mirror: "auto",
  mirrorLabel: "自动选择",
  gitProxyMode: "auto",
  gitProxy: "",
  ...
  runtimeItems: [
    { id: "project", label: "GitHub 项目", status: "installed", detail: "仓库内容已获取", source: "GitHub", link: "https://github.com/LeoSasion/DeepFaceLab-WEBUI" },
...
const readyPreview = {
  ...
  installPath: "C:\\DFL-WEBUI",
  projectDir: "C:\\DFL-WEBUI\\workspace",
  mirror: "auto",
  ...
  runtimeItems: [],
  logs: [
    { time: "12:00:00", tag: "INFO", text: "DeepFaceLab-WEBUI 启动器已准备就绪" },
    { time: "12:00:00", tag: "INFO", text: "项目目录: C:\\DFL-WEBUI\\workspace" },
    ...
    { text: "" },
    { level: "success", text: "================================================" },
    { level: "success", text: "  DeepFaceLab-WEBUI 启动器 - 交互菜单" },
    { level: "success", text: "================================================" },
    { text: "" },
    { text: "请选择操作:" },
    { text: "[1] 启动 WebUI（推荐）" },
